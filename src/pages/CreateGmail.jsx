...
const CreateGmail = () => { 
    ...
    const data = [{src: "/assets/images/Gmail/Gmail_1.png", text: "Etapa 1: Acesse o site www.gmail.com no seu navegador, e clique em Criar conta.", key: 1},
                  ...
                  {src: "/assets/images/Gmail/Gmail_5.png", text: "Etapa 5: Informe o código que recebeu no celular cadastrado e prossiga.", key: 2},                  
                  {src: "/assets/images/Gmail/Gmail_6.png", text: "Etapa 6: Nessa etapa vamos clicar em Pular, se quiser adicionar seu número de telefone para vincular à sua conta clique em Sim, e prossiga.", key: 2},
                  {src: "/assets/images/Gmail/Gmail_7.png", text: "Etapa 7: Finalizando, leia os termos e no final da página selecione se concorda com os mesmos, e clique em Criar conta, sendo assim criado seu email..", key: 2}
